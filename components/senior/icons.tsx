...
export function SpeakerIcon({ size = 16, color = "currentColor" }: IconProps) {
  return (
...
export function HomeIcon({ size = 24, color = "currentColor", filled = false }: IconProps) {
  return (
...
export function BookmarkIcon({ size = 24, color = "currentColor", filled = false }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill={filled ? color : "none"} stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function TypeIcon({ size = 24, color = "currentColor" }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
