  ...
  return (
    <div className="app-shell max-w-3xl py-20">
      <Panel>
        ...
        <h1 className="mt-4 text-4xl font-extrabold leading-[1.35] text-gray-900">신청이 정상적으로 접수되었습니다.</h1>
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-4">
          <Link
            href="/"
            className="inline-flex min-h-12 items-center justify-center rounded-2xl border border-gray-300 bg-white px-5 py-3 text-base font-semibold text-gray-900 transition hover:border-gray-400 hover:bg-gray-50"
          >
            지난 소식 보기
          </Link>
